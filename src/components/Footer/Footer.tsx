...
function Footer() {
  ...
  const isComprarPage = location.pathname === "/comprar";
  
  return(
    <div id="footer" className={`w-full h-70 z-10  ${isComprarPage ? 'mt-[60%] bg-green-900 text-white' : 'bg-green-900 mt-[163%] text-white'}`}>
  ...
  <div className="mt-[-10px] bg-zinc-800 text-center py-4 text-sm">
    © Encanto Amazônico 2025 | Design by Estudantes do Curso de FrontEnd - CETAM
  </div>
</div>
